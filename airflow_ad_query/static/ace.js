(function () {
    ...
    function c(r) {
        ...
        var i = {}, s = "", o = document.currentScript || document._currentScript, u = o && o.ownerDocument || document,
    ...
    var r = e("./lib/lang"), i = e("./lib/oop"), s = e("./lib/net"), o = e("./lib/dom"),
    ...
    t.commands = [{
        ...
        name: "goToNextError", description: "Go to next error", bindKey: o("Alt-E", "F4"), exec: function (e) {
        ...
        name: "toggleFoldWidget", description: "Toggle fold widget", bindKey: o("F2", "F2"), exec: function (e) {
